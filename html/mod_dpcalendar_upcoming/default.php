...
$document->addStyleSheet(JURI::base() . 'templates/template-camoes-home/html/mod_dpcalendar_upcoming/default.css');
...
foreach ($events as $event){
	...
	if ($grouping)
	{
        ...
        <p style="clear: both;">
            <strong>
                <?php echo htmlspecialchars($groupHeading);?>
            </strong>
        </p>
        <?php
		}
        ...
        <div itemprop="event" itemscope itemtype="http://schema.org/Event">
            ...
            <div class="dp-upcoming-calendar" style="background-color: #<?php echo $event->color?>">
                <div class="dp-upcoming-text-month">
                    <?php echo $startDate->format('M', true);?>
                </div>
                <div class="dp-upcoming-text-day">
		...
		if ($params->get('show_location') && isset($event->locations))
		{
			...
			{ ?>
                <div class="dp-location"
                    ...
                    <a href="http://maps.google.com/?q=<?php echo htmlspecialchars(DPCalendarHelperLocation::format($location));?>" target="_blank">
