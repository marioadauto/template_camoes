...
$hasImage = isset($images->image_fulltext) && !empty($images->image_fulltext);

JHtml::addIncludePath(JPATH_COMPONENT . '/helpers');
?>


<?php echo JLayoutHelper::render('joomla.content.image_fulltext', $this->item); ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-4 col-lg-3">
        ...
        <div class="img-intro-<?php echo htmlspecialchars($imgfloat); ?>"
            style="background-image: url(/<?php echo htmlspecialchars($images->image_fulltext); ?>"></div>
    </div>
    <?php endif; ?>
