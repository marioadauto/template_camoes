    ...
    <div class="col-xs-12 col-sm-8">
        <div class="row-fluid">
            ...
            <div itemscope itemtype="http://schema.org/Event">
                ...
                <h2>
                    <a href="<?php echo DPCalendarHelperRoute::getEventRoute($event->id, $event->catid)?>" itemprop="url">
                        <span itemprop="name">
                ...
                <div class="pull-left width-20">
                    <a href="<?php echo DPCalendarHelperRoute::getBookingFormRouteFromEvent($event, $return)?>">
                        <i class="hasTooltip icon-plus"
                           title="<?php echo JText::_('COM_DPCALENDAR_BOOK');?>"></i>
                    </a>
                </div>
                <?php
                }
                ...
                <span class="pull-left width-20">
                    <a href="<?php echo DPCalendarHelperRoute::getFormRoute($event->id, $return);?>">
                        <i class="hasTip icon-edit" title="<?php echo JText::_('JACTION_EDIT');?>"></i>
                    </a>
                </span>
                <?php
                }
                ...
                <span class="pull-left width-20">
                    <a href="<?php echo JRoute::_(
                        ...
                        <i class="hasTip icon-remove" title="<?php echo JText::_('JACTION_DELETE');?>"></i>
                    </a>
                </span>
                <?php
                }
                ...
                <small class="list-author muted event-calendar">
                    <?php
                echo JText::_('COM_DPCALENDAR_FIELD_CONFIG_EVENT_LABEL_CALANDAR');
                    ?>: <?php
                echo $calendar != null ? $calendar->title : $event->catid;
                    ?>
                </small>
                ...
                if ($event->price != '0.00' && $event->price)
                {
                    echo '<br/>' . JText::_('COM_DPCALENDAR_FIELD_PRICE_LABEL') . ': ' . $this->escape($event->price . ' ' . DPCalendarHelper::getComponentParameter('currency_symbol', '$'));
                }
                    ?>
                </small>
 ...
 if (DPCalendarHelper::canCreateEvent())
{
	...
	if (! empty($return))
	{
        ...
        ?>
        <span class="pull-left width-20">
            <a href="<?php echo DPCalendarHelperRoute::getFormRoute(0, $return)?>">
                <i class="hasTip icon-file" title="<?php echo JText::_('JACTION_CREATE');?>"></i>
            </a>
        </span>
    </div>
...
<!--<ul class="pager pagenav inline">
    <li class="previous">
        <a href="<?php echo JRoute::_($prevLink);?>">&lt;</a>
    </li>
    <li class="next">
        <a href="<?php echo JRoute::_($nextLink);?>">&gt;</a>
    </li>
</ul>-->
